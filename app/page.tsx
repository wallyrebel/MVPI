  ...
  return (
    <main className="vb-main">
      ...
      <section className="vb-panel">
        <div className="vb-panel-title"><div><p className="vb-eyebrow">Live computer rankings</p><h2>{searching ? 'Team search' : scope === 'Overall' ? 'Statewide' : scope === 'Private' ? 'Private' : `Class ${scope}`}</h2></div><span>{searching ? `${displayed.length} matching team${displayed.length === 1 ? '' : 's'}` : 'Formula MVPI 0.2 · Media data authoritative'}</span></div>
